...
def kpm_sigma_time_gpu(H,direction_1=None,direction_2=None,t_vec=None,Ef=None,Temp=None,M=None,random_vector=None,velocities=None):
    """
    Def:
    ...
    moments_kernel_FD=moments_kernel_FD.astype(np.complex128,order='C')
    ...
    for_time_sigma_gpu(H_kpm.data ,V1.data,V2_kpm.data,H_kpm.indices,H_kpm.len_row,moments_U_vec,moments_kernel_FD,len(t_vec),sigma_vec,random_vector,M,M2)
    return -1j*sigma_vec



def kpm_sigma_time_nequil_gpu(H,direction_1=None,direction_2=None,t_vec=None,U_F_t0=None,U_t0=None,M=None,bounds=True):
    """
    Def:
        Time-dependent conducitivity
    Inputs:
    ...
    ## Necessary arrays for the loop . 
    sigma_vec=np.zeros((len(t_vec)),dtype=np.complex128)
    for_time_sigma_nequil_gpu(H_kpm.data,V1.data,V2_kpm.data,V1_r2.data, H_kpm.indices, H_kpm.len_row ,moments_U_vec,len(t_vec),sigma_vec,U_t0,U_F_t0,M,M2)    
    return 1j*sigma_vec
