...
cdef void matrix_vector_c(Py_ssize_t len_data,double complex[:] data,int[:] indices, Py_ssize_t len_row,complex[:] v, complex[:] v2):
...
cdef void matrix_vector_c_diagonal(Py_ssize_t len_data,complex[:] data,complex[:] diagonal,int[:] indices, Py_ssize_t len_row,complex[:] v, complex[:] v2):
