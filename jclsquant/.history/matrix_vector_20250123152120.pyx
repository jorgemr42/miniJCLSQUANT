...
def matrix_vector_2(int len_data, double complex[:] data,double complex[:] diagonal,long[:] indices, Py_ssize_t len_row,double complex[:] v,double complex[:] v2,int n_threads):
    cdef Py_ssize_t i, j,idx
